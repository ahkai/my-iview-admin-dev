...
export const otherRouter = {
    ...
    component: Main,
    children: [
        { path: 'home', title: {i18n: 'home'}, name: 'home', component: () => import('@/views/mytest/home.vue') },
...
export const appRouter = [
    ...
    // },
    {
        ...
        component: Main,
        children: [
            { path: 'home', title: 'API网关监控', name: 'home_monitor', component: () => import('@/views/mytest/home.vue') },
